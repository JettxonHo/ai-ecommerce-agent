"""Architecture boundaries for the Customer Insight output-only seam."""
...
_PACKAGE = _SRC / "modules/customer_insight"
_FILES = [
    _PACKAGE / "__init__.py",
    _PACKAGE / "application/__init__.py",
    _PACKAGE / "application/skills/__init__.py",
    _PACKAGE / "application/skills/customer_insight_analysis/__init__.py",
    _PACKAGE / "application/skills/customer_insight_analysis/output_contract.py",
]
_ALLOWED_IMPORTS = {
    "__future__",
    "collections.abc",
