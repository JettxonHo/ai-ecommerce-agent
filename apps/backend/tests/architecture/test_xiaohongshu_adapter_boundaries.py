"""Architecture evidence for framework-neutral Xiaohongshu Brief contracts."""
...
import ai_ecommerce_agent.modules.xiaohongshu_adapter.domain as domain
import ai_ecommerce_agent.modules.xiaohongshu_adapter.domain.contracts as contracts
...
def test_xiaohongshu_adapter_contract_modules_are_framework_neutral() -> None:
...
def test_xiaohongshu_adapter_contract_imports_have_no_io_or_resource_construction() -> (
    None
):
    for module in (contracts, public, domain):
        tree = _module_tree(module)
...
def test_xiaohongshu_adapter_public_facade_contains_only_immutable_contracts() -> None:
...
def test_xiaohongshu_adapter_contract_uses_task_public_version_reference() -> None:
