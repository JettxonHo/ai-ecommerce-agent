"""Private mapping from one DeepSeek Chat Completion to model contracts."""
...
_INCOMPLETE_MESSAGE = "DeepSeek output is incomplete"
_CANCELLED_MESSAGE = "DeepSeek call was cancelled or superseded"
_TRANSIENT_MESSAGE = "DeepSeek provider response was transient"
_REFUSAL_MESSAGE = "DeepSeek provider refused the request"
_INVALID_CANDIDATE_MESSAGE = "DeepSeek output was not valid JSON"
...
def _reject_nonfinite(value: str) -> _NoReturn:
