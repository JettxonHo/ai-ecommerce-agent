...
- **当前 Gate：** P4B is provider-free local release evidence recorded in the P4 review; independent five-axis ORCHESTRATOR review and final Goal Review remain required. No Provider, model, Secret, public-contract, migration, dependency, lockfile, OpenAPI or platform action is authorized. Full access for ordinary reversible in-contract local work does not override independent review, Secret/provider/platform gates, destructive-action controls, public-contract/migration gates or the exact implementation-agent rule.
