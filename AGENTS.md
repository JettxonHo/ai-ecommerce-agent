...
- **当前 Gate：** M1 Contract & Compatibility 已完成：Issues #63～#67 全部关闭，PR #69 / #70 / #71 / #72 / #74 已合并；authored OpenAPI、虚构验收资料、local PostgreSQL、TS-01 与 TS-03 均形成可复核证据，两个 stop-first Slice 均为 PASS，但不等于生产业务模块已实现。M2 的 Task Management vertical slice 已完成：#77 / #78 / #79 与 tracking parent #80 已关闭；#80 的七个子 Issue（#87 / #90 / #91 / #88 / #95 / #98 / #89）均已关闭，PR #84 / #85 / #86 / #92 / #93 / #94 / #96 / #97 / #99 / #100 均已合并，Task / Run / Stage 的 migration、adapter、application 与 CAS 证据已通过。Source persistence vertical slices through PR #155 are merged at the PR #155 Source implementation baseline (merge `cd6bd02fc09a6698d4991dda671131ce03217bcf`): the #109～#113 foundation wave (catalogs/snapshots, SourceVersion/processing and association domains, typed ports, and single-head `0003_source_evidence`) is extended by SQLAlchemy Core tables/mappings, PostgreSQL repositories and specialized UoW/factory (#121/#124/#126), processing application contracts/service with CAS composition (#128/#130), Source-owned association remove/replace contracts/service with Task ownership and atomic add-successor-before-old-CAS evidence (#151/#153), and additive immutable no-commit SourceVersion/processing and Task-owned association reads (#155). #81 remains OPEN and M2 remains PARTIAL: registration/intake and exact submitted-input metadata, final RFC-005 Source HTTP/wire DTOs or API/generated client, parser/fragment/retrieval/evidence, Worker, Provider and Web business UI are not implemented. `0003_source_evidence` remains a minimal identity/processing/association schema, not the final intake schema. #82 remains OPEN; DEC-077 accepted P-78A～P-81A ownership boundaries, while P-82A～P-86A remain Proposed/pending and Review lifecycle/schema and complete outcomes are not implemented. M7 当前为 PARTIAL：MVP0-036 Web Foundation 已由 PR #104 合并（merge `adcc38f`），提供 React/Vite no-API shell、锁定工具链与确定性 Web checks；业务路由、generated client、API-backed Workbench 和其他 M7 slices 仍未实现。用户已于 2026-08-09 接受 P-74A～P-81A，并由 DEC-076 / DEC-077 冻结 Source、Review / Brief / Export 的实现所有权与原子边界；Goal 已恢复执行。不得声称 Source、Review、Brief、Export、Runtime、API、Provider 或 Web 业务能力超过上述实际切片；继续按独立 Issue 和任务合同实现，Technical Spike / Live Provider 仅在相应 Issue 明确授权的受控边界内执行。
