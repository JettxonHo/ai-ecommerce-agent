...
- **当前阶段：** [DEC-087](docs/decisions/dec-087-mvp0l-terminal-rebaseline-and-pilot-activation.md) 的 docs-only rebaseline 正在 [Issue #339](https://github.com/JettxonHo/ai-ecommerce-agent/issues/339) 分支上等待独立 Review。Branch truth：MVP-0L `REBASELINE_PENDING`、Real Product-to-Brief Pilot `ACTIVATION_PENDING`、P0 `NOT_STARTED`。Only after this PR reaches `main`：MVP-0L `TERMINAL_INCOMPLETE_L5_FAILED`、Pilot `ACTIVE`、P0 `READY_NOT_STARTED`。
