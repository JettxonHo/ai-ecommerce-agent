...
- **开发状态：** ACTIVE — FL-1 deterministic browser-to-backend loop 与 FL-3 one-command local demo 已完成；[PR #271](https://github.com/JettxonHo/ai-ecommerce-agent/pull/271) 已按 [DEC-079](docs/decisions/dec-079-deepseek-v4-pro-mvp0-real-provider-amendment.md) 合并 direct DeepSeek official `deepseek-v4-pro` private adapter、项目 Schema / bounded Domain admission 与 opt-in smoke seam。当前状态是 `IMPLEMENTED_OFFLINE_NOT_LIVE_VERIFIED`；旧 [MVP-0 Goal](docs/goals/end-to-end-demo-mvp0-goal.md) 的已完成工作保留，剩余横向 Backlog 不再自动执行。
