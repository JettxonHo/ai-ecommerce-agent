...
| RFC-005 | [Source Processing and Retrieval Architecture](rfc-005-source-processing-and-retrieval-architecture.md) | Wave 3 | `DRAFTING`（DQ-01～06 Accepted by DEC-067 / 068；P-64～P-66 Proposed） |
