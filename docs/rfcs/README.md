...
| RFC-004 | [API and Human Review Architecture](rfc-004-api-and-human-review-architecture.md) | Wave 3 | `DRAFTING`（Issue #54；DQ-01～03 Accepted，DQ-04～06 Proposed，DQ-07～10 Pending） |
