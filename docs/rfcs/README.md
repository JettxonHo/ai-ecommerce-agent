...
| RFC-005 | [Source Processing and Retrieval Architecture](rfc-005-source-processing-and-retrieval-architecture.md) | Wave 3 | `DRAFTING`（DQ-01～03 Accepted by DEC-067；P-61～P-63 Proposed） |
