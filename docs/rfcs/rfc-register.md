...
> 
> **Current truth（2026-08-07）：** Product Specification 已整体闭合；RFC-001 / RFC-002 / RFC-003 / RFC-004 / RFC-006 = `ACCEPTED`。RFC-004 的 P-48A～P-57A / DQ-01～10 已由 DEC-063～066 接受，Final Consistency Review = PASS，用户已明确接受 RFC 整体并允许合并 PR #55、关闭 Issue #54；当前进入 RFC-005 策划 Gate。RFC-005 / 007 = `PROPOSED`。FND-001～003 已完成。Wave 1 中 ARP-01 / 04 / 10 完整 Accepted，ARP-02 / 03 / 09 仅 TS-01 Minimum Slice Accepted。当前授权 RFC 与 Readiness 规划，不授权 TS-01～TS-05 执行、Business / Production Implementation 或实际 Goal；已完成的 Spike-001 不在本禁令所指范围内。
...
- **RFC-001、RFC-002、RFC-003、RFC-004 与 RFC-006 已 `ACCEPTED`**（用户正式决定）；RFC-005 / RFC-007 为 `PROPOSED`。各 RFC 的正文与接受与否由用户在相应 Decision Gate 决定。
