...
> 
> **Current truth（2026-08-06）：** RFC-001 / RFC-002 = `ACCEPTED`；RFC-003 = `IN REVIEW`（P-19A～P-21A 已由 DEC-049 接受，P-22A～P-24A 已由 DEC-050 接受，P-25A～P-27A 已由 DEC-051 接受；DQ-01～09 已闭合，RFC 整体尚未 Accepted）；RFC-004～RFC-007 = `PROPOSED`。FND-001～003 已完成。Wave 1 中 ARP-01 / 04 / 10 完整 Accepted，ARP-02 / 03 / 09 仅 TS-01 Minimum Slice Accepted。当前授权 RFC 与 Readiness 规划，不授权 TS-01～TS-05 执行、Business / Production Implementation 或实际 Goal；已完成的 Spike-001 不在本禁令所指范围内。
...
- **RFC-001 与 RFC-002 已 `ACCEPTED`**（用户正式决定）；RFC-003 当前为 **`IN REVIEW`**；RFC-004～RFC-007 当前为 **`PROPOSED`**。各 RFC 的正文与接受与否由用户在相应 Decision Gate 决定。
...
| RFC-003 | **[LangGraph Runtime and Checkpoint Architecture](rfc-003-langgraph-runtime-and-checkpoint-architecture.md)**（生产 Checkpointer、Safe Resume、Worker、Checkpoint 对账与兼容） | Wave 2 | P0 | `IN REVIEW`（DEC-049～051 已接受 DQ-01～09 输入；整体未 Accepted） | Workflow Runtime / Resume | DEC-013/023/024/033/049/050/051 · runtime/failure-recovery spec | R-3 |
...
RFC-003 Status = IN REVIEW (DEC-049 / DEC-050 / DEC-051 accepted inputs DQ-01 through DQ-09; RFC acceptance not granted)
RFC-004 through RFC-007 Status = PROPOSED
