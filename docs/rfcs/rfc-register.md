...
> 
> **Current truth（2026-08-07）：** Product Specification 已整体闭合；RFC-001 / RFC-002 / RFC-003 / RFC-004 / RFC-006 = `ACCEPTED`。当前 [RFC-005](rfc-005-source-processing-and-retrieval-architecture.md) = `DRAFTING`（Issue #56 / Draft PR #57；P-58A～P-66A / DQ-01～09 Accepted by DEC-067～069；P-67 / DQ-10 Proposed），RFC-007 = `PROPOSED`。FND-001～003 已完成。Wave 1 中 ARP-01 / 04 / 10 完整 Accepted，ARP-02 / 03 / 09 仅 TS-01 Minimum Slice Accepted。当前授权 RFC 与 Readiness 规划，不授权 TS-01～TS-05 执行、Business / Production Implementation 或实际 Goal；已完成的 Spike-001 不在本禁令所指范围内。
...
| RFC-005 | **[Source Processing and Retrieval Architecture](rfc-005-source-processing-and-retrieval-architecture.md)**（生产检索：词法/向量/融合、权限与版本过滤、证据装配） | Wave 3 | P0 | `DRAFTING`（DQ-01～09 Accepted by DEC-067～069；P-67 Proposed） | Retrieval & Evidence Runtime | DEC-014/025/032/039/045/047/057/059～061/067～069 · runtime/hybrid-retrieval spec | R-2 |
