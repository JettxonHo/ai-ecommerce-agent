...
| RFC-003 | **[LangGraph Runtime and Checkpoint Architecture](rfc-003-langgraph-runtime-and-checkpoint-architecture.md)**（生产 Checkpointer、Safe Resume、Worker、Checkpoint 对账与兼容） | Wave 2 | P0 | `DRAFTING`（DEC-049 已接受 DQ-01～03 输入；整体未 Accepted） | Workflow Runtime / Resume | DEC-013/023/024/033/049 · runtime/failure-recovery spec | R-3 |
...
RFC-003 Status = DRAFTING (DEC-049 accepted inputs only; RFC acceptance not granted)
