...
| RFC-004 | **[API and Human Review Architecture](rfc-004-api-and-human-review-architecture.md)**（生产 API 边界、Human Review 提交/暂停协议、权限） | Wave 3 | P0 | `DRAFTING`（Issue #54；P-48～P-50 Proposed） | Review / Orchestration 接口层 | DEC-007/029/044～047/055～057/059～062 · workflow/human-review spec | R-1 |
