...
| RFC-005 | **[Source Processing and Retrieval Architecture](rfc-005-source-processing-and-retrieval-architecture.md)**（生产检索：词法/向量/融合、权限与版本过滤、证据装配） | Wave 3 | P0 | `FINAL REVIEW PASS`（DQ-01～10 Accepted by DEC-067～070；整体待用户接受） | Retrieval & Evidence Runtime | DEC-014/025/032/039/045/047/057/059～061/067～070 · runtime/hybrid-retrieval spec | R-2 |
