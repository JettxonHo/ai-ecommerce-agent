...
The Issue #341 seven-path allowlist is merge-effective and unchanged. Issue #343 / PR #344 has its own exact seven-path allowlist and its characterization report remains byte-identical. Issue #345 has the exact eight-path allowlist: `apps/backend/tests/integration/test_fl2_deepseek_live_smoke.py`, `apps/backend/tests/unit/test_fl2_live_controls.py`, `AGENTS.md`, `README.md`, `docs/goals/real-product-to-brief-pilot-goal.md`, `docs/handoffs/implementation-readiness.md`, `docs/reviews/real-product-to-brief-pilot-p1-harness-repair.md` and `docs/sessions/session-014-real-product-to-brief-pilot-p1-harness-repair.md`. DEC-086, DEC-087, the existing Pilot Contract, P0 plan/Session-012, the L5 review, Issue #343's P1 report, production source beyond the retained smoke consumer and existing live-evidence schema remain unchanged. Issue #345 performs no observation, Provider call, participant test, numerator, export artifact or P1/P2 advancement; `PILOT_EXECUTION_AUTHORIZATION` remains `NOT_AUTHORIZED`.
...
Issue #345 branch: P1R harness repair `P1R_HARNESS_REPAIR_IN_PROGRESS`; `HARNESS_BLOCKER = REPAIRED` is merge-effective only on `main`; no Provider/Secret/Pilot execution
