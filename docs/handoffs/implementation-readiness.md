...
> **Pilot boundary:** the [Real Product-to-Brief Pilot Goal](../goals/real-product-to-brief-pilot-goal.md) is `ACCEPTED / NOT ACTIVE` under [DEC-086](../decisions/dec-086-real-product-to-brief-pilot.md). Activation waits for MVP-0L `COMPLETE` or an owner-approved formal rebaseline. The current L5 [Issue #335](https://github.com/JettxonHo/ai-ecommerce-agent/issues/335) / [PR #336](https://github.com/JettxonHo/ai-ecommerce-agent/pull/336) records terminal `L5_REAL_AI_ACCEPTANCE_FAIL_NO_EXPORTS` at exact head `2210d68ad6e09e1a402dd63b0cd9b2a52cdfe74f`; its one-time authorization is consumed and no further run is authorized. G0 does not resume it. Pilot P0→P6 is a future serial contract, not current runtime evidence. Each later bounded paid execution or cohort needs a fresh exact-commit owner authorization specifying maximum tasks, calls, cost and stop rules; no authorization is inherited.
...
Real Product-to-Brief Pilot (DEC-086 / Issue #337): `ACCEPTED / NOT ACTIVE`; activation blocked until MVP-0L `COMPLETE` or owner-approved formal rebaseline; G0 docs-only, does not resume #335 / PR #336 or authorize another run
