...
见 [decision-log.md](decision-log.md)。当前最新 Accepted Decision 为 [DEC-068](dec-068-postgresql-native-versioned-and-deterministic-retrieval-baseline.md)；旧决定被修订时保留原文并通过 `Amends / Amended by` 追踪。
