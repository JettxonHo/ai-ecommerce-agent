...
- **Status:** Accepted — Extended by [DEC-065](dec-065-immutable-brief-export-problem-and-fixed-workspace-api-boundary.md) and [DEC-066](dec-066-openapi-contract-catalog-compatibility-and-generated-client-adoption.md)
- **Date:** 2026-08-07
...
- RFC-004 的 Brief / Export、Problem taxonomy 与固定工作区身份后由 DEC-065 冻结；最终 OpenAPI Closure 后由 DEC-066 冻结。
...
- DQ-07～09 后由 DEC-065、DQ-10 后由 DEC-066 接受；Final Consistency Review 已通过，用户 RFC 整体接受仍是后续 Gate。
