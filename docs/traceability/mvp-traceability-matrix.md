...
| Autonomous low-risk PR flow and model roles | DEC-040 / DEC-043 / DEC-071 | [Collaboration Model](../governance/collaboration-model.md) | — | PR #31 + Issue #34 + Issue #61 | All | Goal governance | Exact `luna-worker` route + independent Sol review + Required Checks |
...
| Sol / `luna-worker` task routing, Terra authorization, thread isolation and review independence | DEC-043 / DEC-071 | [Collaboration Model](../governance/collaboration-model.md) | — | DEC-043 / DEC-071 + Issue #61 | All | Goal governance | Exact custom Agent name + config/runtime verification status + independent reviewer + Required Checks |
...
|---|---|---|---|
| OpenAPI / public state / errors | DEC-063～066 / RFC-004 | M1 `MVP0-001`; M6 `MVP0-030～035` | OAS lint, representative Contract tests, generated-client clean diff |
| Fictional acceptance data | DEC-048 / 058～062 | M1 `MVP0-002` | manifest validation, no real data, semantic behavior expectations |
| PostgreSQL / UoW / Migration | RFC-002 | M1 `MVP0-003～004`; M2 `MVP0-006～011` | real PostgreSQL transaction, migration, concurrency, rollback / repair |
