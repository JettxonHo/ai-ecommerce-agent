...
| Task / Fact Stage minimum gates, demo file limits and classified conflict handling | DEC-045 | [PRD](../product/prd.md) | — | DEC-045 + Issue #38 | RFC-003, RFC-004, RFC-005 | _(placeholder)_ | Input contract + partial file acceptance + conflict behavior tests _(planned)_ |
...
| 任务级持久状态 + 跨会话 Resume | DEC-013, DEC-024 | [Workflow State](../specs/workflow/workflow-state-specification.md) | spike-05, spike-08 | test_review_safety::spike05/spike08 | RFC-003 | _(placeholder)_ | _(placeholder)_ |
...
RFC-003 through RFC-007 = PROPOSED
