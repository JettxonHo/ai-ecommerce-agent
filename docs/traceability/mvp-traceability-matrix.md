...
| Dedicated PostgreSQL Checkpoint Database, sync durability, reentrant nodes and Current-Truth-first reconciliation | DEC-049 | [RFC-003](../rfcs/rfc-003-langgraph-runtime-and-checkpoint-architecture.md) | spike-05, spike-08 | DEC-049 + Issue #46 | RFC-003（DRAFTING） | _(placeholder)_ | TS-03 isolation / reconciliation + interrupt / resume + duplicate-safe replay _(planned)_ |
