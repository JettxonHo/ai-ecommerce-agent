...
| **FND-001 Candidate — Backend Package and Local Tooling Foundation**（**READY FOR AUTHORIZATION**；Backend Package `apps/backend/src/ai_ecommerce_agent/` + Python 3.13 + uv Lockfile + Ruff/Pyright/pytest/Coverage Local Tooling + Unified Local Commands；Issue Creation & Implementation NOT AUTHORIZED） | DEC-036, DEC-038 | docs/foundation/foundation-issue-candidates.md | — | docs/foundation/foundation-issue-candidates.md | RFC-001（DQ-02 / DQ-03 / DQ-09 / DQ-10） | _(placeholder: FND-001 Issue，未授权创建)_ | _(placeholder)_ |
