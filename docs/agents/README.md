...
> **下一议题：** RFC-001-DQ-05：Skill Code Shape（RFC-001 Status = `DRAFTING`，DQ-01~DQ-04 已接受，未替用户接受 RFC-001 整体）。详见 [../readiness/README.md](../readiness/README.md) 与 [../rfcs/rfc-register.md](../rfcs/rfc-register.md)。
