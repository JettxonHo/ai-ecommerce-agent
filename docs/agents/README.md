...
> **下一议题：** RFC-001-DQ-03：Repository and Package Directory Structure（RFC-001 Status = `DRAFTING`，DQ-01 Modular Monolith First 已接受、DQ-02 Backend Language and LangGraph Binding 已接受，未替用户接受 RFC-001 整体）。详见 [../readiness/README.md](../readiness/README.md) 与 [../rfcs/rfc-register.md](../rfcs/rfc-register.md)。
