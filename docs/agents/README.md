...
> **下一议题：** RFC-001-DQ-08：模块公开契约、跨模块 Command / Query / Event 协作与循环依赖治理（RFC-001 Status = `DRAFTING`，DQ-01~DQ-07 已接受，未替用户接受 RFC-001 整体）。详见 [../readiness/README.md](../readiness/README.md) 与 [../rfcs/rfc-register.md](../rfcs/rfc-register.md)。
