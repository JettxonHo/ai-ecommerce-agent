...
- **仍待闭合：** RFC-004 已整体接受；RFC-005 DQ-01～06 已由 DEC-067 / 068 接受，DQ-07～10 与 RFC-005 整体仍待策划；RFC-007、Retrieval public transport / evidence commit / evaluation、Observability、部署方式与精确实施版本仍待完成。Frontend Architecture 已整体接受。
