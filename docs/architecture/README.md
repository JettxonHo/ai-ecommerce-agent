...
- **仍未决定：** 精确实施版本与最终公共字段；RFC-004 / 005 / 007、公共 API 细节、Retrieval Backend、Observability 产品与部署方式。Frontend Architecture P-36～P-41 已逐项接受且 Final Consistency Review = PASS，仍待整体接受 Gate。
