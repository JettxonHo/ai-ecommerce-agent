...
> **Current sync（2026-08-07）：** RFC-002 / 003 / 004 / 006 已 Accepted。DEC-067～069 冻结 Source graph、Processing、Fragment、PostgreSQL-native derived retrieval、Scope、Evidence 与 evaluation。DEC-070 冻结目标 `text-embedding-3-small` / explicit 1536 / cosine Profile 与公共 catalog；快速 MVP-0 只实施 Direct / Exact / PostgreSQL Lexical，text PDF 与 vector / Semantic / Hybrid 后移 MVP-1，但继续服从同一 SourceSet、eligibility、Validator 与 atomic Evidence commit。RFC-005 DQ-01～10 已闭合、Final Review = PASS、整体待接受。正文旧 `draft_version`、Source `task_id`、`package_hash`、raw-score Fusion、broad post-filter 或 mutable Evidence 示例与该 Current sync 冲突时，以最新 Accepted DEC 为准。
