...
> **Status: ACTIVE PRE-DEVELOPMENT BASELINE（已同步至 DEC-070；RFC-005 整体与最小 RFC-007 待闭合）**
...
> **Current sync（2026-08-07）：** RFC-002 / 003 / 004 / 006 与 Frontend Architecture 已整体接受。DEC-067～069 冻结 Source / Processing / Retrieval / Scope / Evidence；DEC-070 冻结 `text-embedding-3-small` / 1536 / cosine 与 Source / Evidence public catalog，并将快速 MVP-0 限于 Direct / Exact / PostgreSQL Lexical + JSON / text / TXT / Markdown / CSV，text PDF 与 Semantic / Hybrid 后移 MVP-1。RFC-005 DQ-01～10 已闭合、Final Review = PASS、整体待用户接受。用户已确认快速 MVP-0 Gate，但实际 Goal 与实现仍未授权。正文旧 `PENDING` 为历史快照，以最新 Accepted Decision、RFC 与本说明为准。
...
- Frontend Architecture：DEC-055～056 / P-36～P-41、Final Consistency Review 与整体接受均已完成；Test Layering 已接受核心工具 / Browser / Accessibility / Performance 边界，Fixture 与执行证据仍待 Planning Package；Deployment Platform 仍 PENDING。
...
> 本节保留 Foundation 实施期间的收口快照。2026-08-07 当前状态为：RFC-001～003、RFC-006、DEC-055～056 Frontend P-36～P-41、Frontend Final Consistency / overall acceptance 与 FND-001～003 已完成；RFC-004 / 005 / 007、产品最终规格、完整 Readiness Artifact、测试与 Goal 文档仍待策划；TS-01～TS-05 执行、业务实现和实际 Goal 均未授权。
